...
// Join productout and product tables to get product names
$select = mysqli_query($conn, "
    SELECT productout.*, product.ProductName 
    FROM productout 
...
if ($select) {
    ...
    if ($num_rows > 0) {
        ...
        $tbody .= '<tr><td colspan="7" style="text-align:center; font-weight:bold;">No Products found</td></tr>';
    }
} else {
    echo "Not selected";
}
